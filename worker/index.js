...
import { getSecurityPlaneAgentsResponse } from "./data/securityPlaneAgents.js";
...
async function handleApi(request, env, url) {
  ...
  if (method === "GET" && pathname === "/api/security-plane/agents") {
    return json(getSecurityPlaneAgentsResponse(), 200, { "Cache-Control": "no-store" });
  }
