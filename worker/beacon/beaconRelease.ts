...
export type BeaconReleaseEnv = ModeEnv & BuildInfoEnv & {
...
async function verifyRelease(
  ...
  signing: NonNullable<ReturnType<typeof resolveBeaconSigningKey>>,
): Promise<boolean> {
...
export async function getVerifiedBeaconV2State(
  env: BeaconReleaseEnv & SigningKeyEnv,
