    ...
    <article class="telemetry-card bracket">
      <div class="bracket-inner">
        ...
        <div class="cta-row">
          ...
          <a class="button secondary" href="/apps/rag-architecture-planner?source_type=rag_risk_result&source_reference_id=${escapeHtml(result.rag_risk_id || "")}&rag_risk_score=${encodeURIComponent(String(result.rag_risk_score || ""))}&rag_risk_tier=${encodeURIComponent(String(result.rag_risk_tier || ""))}">[ GENERATE RAG ARCHITECTURE PLAN ]</a>
        </div>
      </div>
    </article>
  `;
