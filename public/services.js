...
const SERVICE_LABELS = {
  ...
  cloudflare_security_audit_lite: "Cloudflare Security Audit Lite",
            ...
            <div class="cta-row">
              ${
                service.slug === "ai_security_audit"
                  ...
                  : service.slug === "cloudflare_security_audit_lite"
                  ? `<a class="button primary" href="/apps/cloudflare-security-audit-lite">[ RUN $299 AUDIT ]</a>
                     <a class="button secondary" href="/enter?service=${encodeURIComponent(service.slug)}&source=services-catalog">[ ASK ABOUT IMPLEMENTATION ]</a>`
