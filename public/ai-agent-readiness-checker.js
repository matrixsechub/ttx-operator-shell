    ...
    <div class="readiness-result-shell">
      ...
      <article class="readiness-next-route">
        ...
        <div class="cta-row">
          ...
          <a class="button secondary" href="/apps/ai-agent-builder?source_type=agent_readiness_result&source_reference_id=${encodeURIComponent(result.agent_check_id || "")}">[ GENERATE AI AGENT BUILD SPEC ]</a>
        </div>
      </article>
    </div>
  `;
