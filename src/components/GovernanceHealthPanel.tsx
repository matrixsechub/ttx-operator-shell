    ...
    <div className="op-panel rounded-sm p-4">
      ...
      {loading && !governance ? (
        ...
        <dl className="mt-3 grid grid-cols-2 gap-2 text-[11px]">
          ...
          <div>
            <dt className="text-op-text-dim">Proposal store</dt>
            <dd className={governance?.proposalStoreAvailable ? "text-op-accent" : "text-op-danger"}>
              {governance?.proposalStoreAvailable ? "available" : "unavailable"}
            </dd>
          </div>
          <div>
